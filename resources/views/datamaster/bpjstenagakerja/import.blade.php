<form action="{{ route('bpjstenagakerja.import_proses') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="alert alert-info">
                <h6 class="alert-heading fw-bold mb-1">Informasi Import Data</h6>
                <p class="mb-0">Silakan unduh template Excel terlebih dahulu, isi datanya, lalu unggah kembali di sini.</p>
            </div>
        </div>
    </div>
    <div class="row mt-2">
        <div class="col-12">
            <a href="{{ route('bpjstenagakerja.download_template') }}" class="btn btn-outline-success w-100 mb-3">
