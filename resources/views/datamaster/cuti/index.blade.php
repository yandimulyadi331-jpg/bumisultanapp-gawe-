        ...
        <nav aria-label="breadcrumb" class="d-none d-md-block" style="font-size: 0.75rem;">
            <ol class="breadcrumb breadcrumb-style1 mb-0">
                ...
                <li class="breadcrumb-item active">
                    <i class="ti ti-calendar-event ti-xs me-1"></i> Cuti
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            @can('cuti.create')
                <a href="#" class="btn btn-primary" id="btnCreate">
                    <i class="ti ti-plus me-1"></i> Tambah Cuti
                </a>
            @endcan
        </div>
        <form action="{{ route('cuti.index') }}">
            <div class="row g-2 mb-3">
                <div class="col-lg-10 col-md-9 col-sm-12">
                    <x-input-with-icon label="Cari Jenis Cuti" value="{{ Request('nama_cuti') }}" name="nama_cuti"
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center py-2" style="background-color: var(--theme-color-1) !important; color: white !important; min-height: 50px;">
                <div class="d-flex align-items-center">
                    ...
                    <h6 class="card-title mb-0 text-white">Data Cuti</h6>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        <thead style="background-color: var(--theme-color-1) !important; color: white !important;">
                            <tr>
                                ...
                                <th class="text-white py-3">JENIS CUTI</th>
                                <th class="text-white py-3">JUMLAH HARI</th>
                        ...
                        <tbody>
                            @foreach ($cuti as $d)
                                <tr>
                                    ...
                                    <td class="fw-bold py-2">{{ $d->kode_cuti }}</td>
                                    <td class="py-2">{{ $d->jenis_cuti }}</td>
                                    <td class="py-2">{{ $d->jumlah_hari }} Hari</td>
                                        ...
                                        <div class="d-inline-flex border rounded overflow-hidden shadow-xs">
                                            @can('cuti.edit')
                                                <a href="#" class="btn btn-sm btnEdit px-2 py-1 border-0 rounded-0"
                                                    kode_cuti="{{ Crypt::encrypt($d->kode_cuti) }}" title="Edit"
