<form action="{{ route('gajipokok.import_proses') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
    ...
    <div class="row mt-2">
        <div class="col-12">
            <a href="{{ route('gajipokok.download_template') }}" class="btn btn-outline-success w-100 mb-3">
