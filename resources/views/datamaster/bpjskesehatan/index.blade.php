                            ...
                            @foreach ($bpjskesehatan as $d)
                                <tr>
                                    <td class="py-2 text-center">
                                        <input type="checkbox" class="form-check-input checkItem" name="kode_bpjs_kesehatan[]" value="{{ $d->kode_bpjs_kesehatan }}">
                                    </td>
...
<script>
    $(function() {
        ...
        $("#btnImport").click(function() {
            $("#modal").modal("show");
            $(".modal-title").text("Import Data BPJS Kesehatan");
            $("#loadmodal").load("{{ route('bpjskesehatan.import') }}");
        });
        ...
        $("#btnDeleteMultiple").click(function() {
            ...
            Swal.fire({
                ...
                text: "Anda akan menghapus " + checkedCount + " data BPJS Kesehatan sekaligus!",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    const form = $('<form>', {
                        'method': 'POST',
                        'action': "{{ route('bpjskesehatan.delete_multiple') }}"
                    });
