<form action="{{ route('bpjskesehatan.import_proses') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
    ...
    <div class="row mt-2">
        <div class="col-12">
            <a href="{{ route('bpjskesehatan.download_template') }}" class="btn btn-outline-success w-100 mb-3">
