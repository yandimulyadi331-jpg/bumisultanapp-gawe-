                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control flatpickr-date @error('tanggal_kunjungan') is-invalid @enderror" 
                                        ...
                                        placeholder="Tanggal Kunjungan" value="{{ old('tanggal_kunjungan', date('Y-m-d')) }}">
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror" 
                                        ...
                                        value="{{ old('lokasi') }}" placeholder="Lokasi Kunjungan">
                                    @error('lokasi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <small class="text-muted ms-2" style="font-size: 0.75rem">Format: JPG, PNG, GIF. Max 2MB.</small>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                        ...
                                        placeholder="Deskripsi Kunjungan">{{ old('deskripsi') }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
